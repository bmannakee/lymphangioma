...
We think the large number of variants with allele frequencies at 10-12\% are clonal or nearly clonal heterozygous variants.
...
For areas of moderately low coverage two alternate reads are sufficient for calling a clonal heterozygous variant, but it is not generally advisable to call variants with alternate read counts that low because the risk of an error is quite high.
